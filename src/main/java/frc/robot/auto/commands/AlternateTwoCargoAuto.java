...
public class AlternateTwoCargoAuto extends SequentialCommandGroup {
    private static final double kTwoCargoShotRPM = 0;
    private static final boolean kTwoCargoShotHoodExtended = false;

    public AlternateTwoCargoAuto(Drivetrain drivetrain, Intake intake, Indexer indexer, Shooter shooter) {
        ...
        Pose2d closeShotPosition = makeWaypoint(-1, 0, 12);
        ...
        addCommands(
            ...
            new ParallelRaceGroup(
                new TimedShoot(shooter, ShooterConstants.kCloseShotRPM + 80, ShooterConstants.kCloseShotHoodExtended, 2),
